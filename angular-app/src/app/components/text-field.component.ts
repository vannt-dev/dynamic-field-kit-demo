...
@Component({
  ...
  template: `
    <div class="field-container" [class]="className">
      <label *ngIf="label" style="display: block; margin-bottom: 4px; font-weight: 500;">
      ...
      />
      <small *ngIf="description" style="color: #666; display: block; margin-top: -4px; margin-bottom: 8px;">
        {{ description }}
      </small>
    </div>
  `,
